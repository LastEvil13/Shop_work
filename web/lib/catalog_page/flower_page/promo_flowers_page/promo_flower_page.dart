...
class PromoFlowerPage extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              height: 150,
              decoration: BoxDecoration(
                border: Border.all(color:  Color.fromRGBO(198, 139, 130, 1), width: 2.0),
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(50.0),
                  bottomRight: Radius.circular(50.0),
                ),
                image: DecorationImage(
                  image: AssetImage('assets/image/sale_flower.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Row(
