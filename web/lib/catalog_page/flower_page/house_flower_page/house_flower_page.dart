...
import 'package:flutter_application_main/catalog_page/flower_page/house_flower_page/house_list_flower.dart';
//import 'package:flutter_application_main/catalog_page/bouquets_page/bouquets_list_view.dart';


class HouseFlowerPage extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              height: 150,
              decoration: BoxDecoration(
                border: Border.all(color: Color.fromRGBO(173, 179, 140, 1), width: 2.0),
                borderRadius: BorderRadius.only(
                  bottomLeft: Radius.circular(50.0),
                  bottomRight: Radius.circular(50.0),
                ),
                image: DecorationImage(
                  image: AssetImage('assets/image/house_flower.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Row(
